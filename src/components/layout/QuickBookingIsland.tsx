    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          className="fixed bottom-8 left-1/2 z-[90] w-fit min-w-[280px]"
        >
          <motion.div
            layout
            className={`
              ...
              overflow-hidden flex flex-col items-center transition-all duration-500
            ...
            {!isExpanded ? (
              ...
              >
                ...
                <div className="flex flex-col">
                   <span className="text-[10px] font-black text-primary uppercase tracking-[0.2em] leading-none">Quick Book</span>
                   <span className="text-xs font-bold text-white/80">Đặt vé nhanh phim đang hot</span>
                </div>
              ...
              <div className="w-full space-y-4">
                ...
                <div className="grid grid-cols-1 gap-3">
                   <Link href="/movies" className="flex items-center gap-4 p-3 bg-white/5 hover:bg-white/10 rounded-2xl border border-white/5 transition-all group">
                      ...
                      <div className="flex flex-col text-left">
                         <span className="text-xs font-black text-white">Chọn Phim & Rạp</span>
                         <span className="text-[10px] text-white/40">Tìm suất chiếu gần bạn nhất</span>
                      </div>
                   </Link>
                   ...
                   <div className="flex gap-2">
                      <div className="flex-1 p-3 bg-white/5 rounded-2xl border border-white/5 flex flex-col gap-1 items-center justify-center opacity-50 cursor-not-allowed">
                         ...
                         <span className="text-[10px] font-bold text-white/40">Vị trí</span>
                      </div>
                      <div className="flex-1 p-3 bg-white/5 rounded-2xl border border-white/5 flex flex-col gap-1 items-center justify-center opacity-50 cursor-not-allowed">
                         <Calendar className="w-4 h-4 text-white/40" />
                         <span className="text-[10px] font-bold text-white/40">Ngày xem</span>
                      </div>
                      <div className="flex-1 p-3 bg-white/5 rounded-2xl border border-white/5 flex flex-col gap-1 items-center justify-center opacity-50 cursor-not-allowed">
                         <Clock className="w-4 h-4 text-white/40" />
                         <span className="text-[10px] font-bold text-white/40">Suất chiếu</span>
                      </div>
                   </div>
