  ...
  return (
    ...
    >
      <div className="relative aspect-[16/9] bg-zinc-800 overflow-hidden">
        ...
        <div className={`absolute top-3 left-3 text-xs font-medium px-2.5 py-1 rounded-full border backdrop-blur-sm ${TYPE_BADGE_COLORS[c.type] || TYPE_BADGE_COLORS.OTHER}`}>
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-orange-950/60 via-[#0d0d0d] to-pink-950/40 border-b border-white/5">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
          ...
          <p className="text-zinc-400 text-lg max-w-lg">
            Khám phá hàng loạt ưu đãi độc quyền từ ngân hàng, ví điện tử và đối tác của chúng tôi.
          </p>
        ...
        {!loading && error && (
          <div className="flex flex-col items-center justify-center py-24 gap-4">
            ...
            <div className="text-center">
              ...
              <p className="text-zinc-600 text-sm mt-1">Kiểm tra kết nối hoặc thử lại sau.</p>
            </div>
            <button
        ...
        {!loading && !error && filtered.length === 0 && (
          <div className="flex flex-col items-center justify-center py-24 gap-4">
            ...
            <div className="text-center">
              ...
              <p className="text-zinc-600 text-sm mt-1">Hãy quay lại sau để xem thêm ưu đãi mới nhé!</p>
            </div>
          </div>
        )}
      </div>
